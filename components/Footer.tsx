...
export const Footer: React.FC = () => {
  return (
    <footer className="relative bg-slate-50 dark:bg-slate-950 text-muted-foreground pt-24 pb-16 transition-colors duration-300 border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-1">
            <ScrollReveal delay={0}>
              <div className="mb-6">
                <Logo iconClassName="w-8 h-8" className="text-slate-900 dark:text-white" />
              </div>
          ...
          <div>
            <ScrollReveal delay={100}>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Chat Intelligence</a></li>
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Image Generation</a></li>
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Code Assistant</a></li>
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Video & Voice</a></li>
              </ul>
            </ScrollReveal>
          </div>
          ...
          <div>
            <ScrollReveal delay={200}>
              ...
              <ul className="space-y-3 text-sm">
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">About</a></li>
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Blog</a></li>
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Careers</a></li>
          ...
          <div>
            <ScrollReveal delay={300}>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><a href="#" className="text-slate-600 dark:text-slate-400 hover:text-primary transition-colors">Security</a></li>
              </ul>
            </ScrollReveal>
          </div>
        </div>
