      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <ScrollReveal delay={300}>
          <Spotlight className="max-w-4xl mx-auto rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl overflow-hidden">
            <div className="p-1 bg-slate-50 dark:bg-slate-800 flex items-center justify-between px-4 border-b border-slate-200 dark:border-slate-700">
            ...
            <div className="p-6 md:p-10 space-y-6">
              ...
              <div className="flex gap-4">
                <div className="w-8 h-8 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center shrink-0 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400">
