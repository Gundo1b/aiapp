        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {tiers.map((tier, index) => (
            <ScrollReveal key={tier.name} delay={index * 150} className="h-full">
              <div 
                className={`relative bg-white dark:bg-slate-900 rounded-2xl p-8 flex flex-col h-full transition-all duration-300 hover:-translate-y-2 group ${
                  tier.isPopular 
              ...
              >
                ...
                {/* Regular Border for non-popular items, handled by CSS above, but ensuring background is safe */}
